...
- [Replicating Mojaloop project and environment](#replicating)
- [Executing regression test](#executing)
- [Postman regression test with Newman](#postman)
- [Automation and scheduling](#automation)
